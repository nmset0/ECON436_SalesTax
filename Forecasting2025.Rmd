...
```{r compare}
Forecast2024 <- pred_vec2var_ca.jo2024[["fcst"]][["Lead_STF_Real"]][,1] # Extract forecasted values
Actual2024 <- LDF$Lead_STF_Real[FD_1$year == 2024] # Extract observed values

AE <- abs(Forecast2024 - Actual2024) # Calculate individual absolute error
MAE <- mean(AE) # Mean error
